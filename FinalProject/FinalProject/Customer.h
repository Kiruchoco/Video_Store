...
// 버전 3.5 이상을 사용해야 합니다).
	...
	long	m_No;
	CStringW	m_Cu_ID;	//아이디
	CStringW	m_Cu_PW;	//비밀번호
	CStringW	m_Cu_Name;	//이름
	CStringW	m_Cu_Tel;	//연락처
	CStringW	m_Cu_Address;	//주소
	long	m_Cu_VideoCount;	//빌린 비디오 갯수
